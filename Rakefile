# https://raw.githubusercontent.com/plusjade/jekyll-bootstrap/master/Rakefile
...
desc "Begin a new post in #{CONFIG['posts']} - `rake post title='foo' category=`bar` tags=`baz` "
task :post do
